...
public class SuperGenerator  {
    ...
    protected StrategyConfig getStrategyConfig(String tableName) {
        ...
        return new StrategyConfig()
                ...
                //自定义实体父类
                .setSuperEntityClass("com.hower.hotel.framework.model.BaseModel")
                // 自定义实体，公共字段
                .setSuperEntityColumns("id")
                .setTableFillList(tableFillList)
                // 自定义 mapper 父类
//                .setSuperMapperClass("com.hower.hotel.framework.mapper.BaseMapper")
//                // 自定义 controller 父类
//                .setSuperControllerClass("com.hower.hotel.framework.controller.SuperController")
                // 自定义 service 实现类父类
//                .setSuperServiceImplClass("com.hower.hotel.framework.service.impl.BaseServiceImpl")
                // 自定义 service 接口父类
//                .setSuperServiceClass("com.hower.hotel.framework.service.BaseService")
    ...
    protected DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig()
                ...
                .setUsername("root")
                .setPassword("123456")
                .setUrl("jdbc:mysql://127.0.0.1:3306/hower_hotel?characterEncoding=utf8&serverTimezone=Asia/Shanghai");
    }
    ...
    protected String getJavaPath() {
        String javaPath = getRootPath() + "/hotel/src/main/java";
    ...
    protected String getResourcePath() {
        String resourcePath = getRootPath() + "/hotel/src/main/resources";
